...
import com.dominio.Pelicula;
import com.servicio.IServicioPeliculas;
import com.servicio.ServicioPeliculasArchivo;
import com.servicio.ServicioPeliculasLista;
...
//        IServicioPeliculas servicioPeliculas = new ServicioPeliculasLista();
        ...
        while(!salir) {
            try {
                mostrarMenu();
                salir = ejectuarOpciones(consola, servicioPeliculas);
            } catch (Exception e) {
    ...
    private static boolean ejectuarOpciones(Scanner consola, IServicioPeliculas servicioPeliculas) {
